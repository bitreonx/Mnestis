...
export const SEO = {
  ...
  /** Web manifest + schema.org taxonomy */
  categories: ["developer", "productivity", "utilities", "business"] as const,
...
export const PAGES: Record<string, PageSeo> = {
  ...
  achievements: {
    ...
    description:
      "Timeline of Mnestis memory layer releases: hybrid recall, token packing, MCP playbooks, INFERNO benchmarks. Reproducible local-first intelligence.",
    path: "/achievements",
  },
};
