...
export const NAV_LINKS = [
  ...
  { label: "Ship log", href: "/achievements", route: true },
...
export const COMPARISON = {
  ...
  rows: [
    ...
    { feature: "Token-budget pack() knapsack", Mnestis: true, understandAnything: false, graphify: "partial", gitingest: false, madge: false },
    { feature: "Graph-augmented hybrid recall", Mnestis: true, understandAnything: "partial", graphify: true, gitingest: false, madge: false },
    { feature: "Obsidian vault export (wikilinks)", Mnestis: true, understandAnything: false, graphify: false, gitingest: false, madge: false },
    { feature: "Episodic memory + decay", Mnestis: true, understandAnything: false, graphify: false, gitingest: false, madge: false },
  ],
} as const satisfies {
