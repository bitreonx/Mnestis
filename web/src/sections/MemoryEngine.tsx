...
const FEATURES = [
  ...
  {
    icon: Brain,
    title: "Hybrid Recall + pack()",
    desc: "Vector + BM25 + graph BFS fused, then greedy knapsack fits your token budget — savings printed every run.",
  },
  {
    icon: Zap,
    title: "Obsidian Vault Export",
    desc: "Export `.mentis/vault/` with wikilinks — browse architecture in Obsidian, query via MCP.",
  },
  {
    icon: Shield,
