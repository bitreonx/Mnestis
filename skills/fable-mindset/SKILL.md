...
- Read Mnestis DNA (`.mentis/project.dna.json`) before random repo grepping.
...
- Use MCP `playbook` for auth bugs, test failures, refactors ? don't reinvent the workflow.
